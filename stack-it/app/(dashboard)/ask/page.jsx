...
import { ArrowLeft, Upload, X, Bold, Italic, List, LinkIcon, Tag, Send } from "lucide-react"
...
const page = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      // In real app, this would redirect to the new question
      console.log({
        title,
        description,
        tags,
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 p-2 border rounded-md bg-muted/50">
              ...
              <div className="ml-auto text-xs text-muted-foreground">Supports Markdown formatting</div>
            </div>

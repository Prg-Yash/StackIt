          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col items-center gap-2">
              <Button
                ...
                disabled={!session}
                className={`h-8 w-8 p-0 ${question.votes.includes(session?.user?.id)
                    ? "text-primary"
                    : ""
                  }`}
              >
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col items-center gap-2">
                  <Button
                    ...
                    disabled={!session}
                    className={`h-8 w-8 p-0 ${answer.votes.includes(session?.user?.id)
                        ? "text-primary"
                        : ""
                      }`}
                  >
                              ...
                              <div className="flex gap-4">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                  <Button
                                    ...
                                    disabled={!session}
                                    className={`h-6 w-6 p-0 ${reply.votes.includes(session?.user?.id)
                                        ? "text-primary"
                                        : ""
                                      }`}
                                  >
